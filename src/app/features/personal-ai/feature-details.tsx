...
const benefits = [
  ...
  'Personalize gifts based on real signals',
  'Stand out in every inbox and on every desk',
  'Measure what actually drives meetings',
];

const faqs = [
  {
    question: 'What signals does Gently track?',
    answer: 'Career changes, funding announcements, company news, social media activity, and competitor movements — all monitored automatically.',
  },
  {
    question: 'Can I approve before sending?',
    answer: 'Yes — every touch is reviewed and approved by you before anything ships.',
  },
];
    ...
    <div className="feature-details-wrap">
      <section className="feature-detail-section" aria-labelledby="team-growth-title">
        ...
        <div className="feature-detail-copy">
          ...
          <h2 id="team-growth-title">Turn prospect signals into booked meetings</h2>
          <p>
            Know exactly when a prospect is ready to hear from you — and show up with something they won&apos;t forget.
          </p>
          <ul>
      ...
      <section className="feature-detail-section feature-detail-reverse" aria-labelledby="productive-hours-title">
        ...
        <div className="feature-detail-copy">
          ...
          <h2 id="productive-hours-title">Know what lands, every time</h2>
          <p>
            See which signals triggered the send, track delivery, and measure reply rates and meetings booked — all in one place.
          </p>
